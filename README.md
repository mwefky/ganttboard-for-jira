...
Free for everyone through **January 1, 2027**. Paid tiers then start at **$1.20/user/month** (11–100 users), scaling down to **$0.04/user/month** at 1,000+ users — a fraction of BigGantt, WBS Gantt, or GanttTable.
...
Free for everyone until **January 1, 2027**. See full pricing on the [Marketplace listing](https://marketplace.atlassian.com/apps/ganttboard-for-jira).
